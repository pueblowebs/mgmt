...
export function ProSection() {
  return (
    <section id="pro" className="py-24 bg-foreground text-background">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
          ...
          <div className="relative aspect-square md:aspect-video lg:aspect-square w-full max-w-[500px] mx-auto lg:ml-auto overflow-hidden rounded-4xl">
            ...
            <Image
              src="/images/foto-pro-vertical.webp"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32">
          ...
          <div className="bg-secondary/5 p-8 md:p-12 border border-background/10 rounded-sm self-start">
            ...
            <div className="mt-12 pt-12 border-t border-background/10 flex flex-col items-center">
               <a 
